...
@section('page_title', 'Ajouter un Programme')

@section('content')
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2 text-primary"></i>Nouveau Programme</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.programs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Utilisé dans l'URL (ex: education)</small>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="fas fa-graduation-cap">
