...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0"><i class="fas fa-edit me-2 text-primary"></i>Modifier le Témoignage</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="organization" name="organization" value="{{ old('organization', $testimonial->organization) }}">
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $testimonial->photo) }}" alt="Current photo" style="max-width: 150px; max-height: 150px; border-radius: 50%;">
